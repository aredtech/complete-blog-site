...
urlpatterns = [
    ...
    path("thank-you-for-messaging-us/", views.ThankYouView.as_view(), name="thanks-message-us"),
    path("thank-you-for-comment/", views.ThankYouCommentView.as_view(), name="thanks-comment"),
